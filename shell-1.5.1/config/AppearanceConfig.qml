...
JsonObject {
    ...
    component AnimDurations: JsonObject {
        ...
        // Smooth mode durations (faster for better responsiveness)
        property int fastSmall: 100 * scale
        property int fastNormal: 200 * scale
        property int fastLarge: 300 * scale
    }
